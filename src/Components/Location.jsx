...
export default function Location(){
    return(
        <section className="bg-black text-white w-full px-6 py-12 md:px-12 md:py-16 font-sans overflow-hidden">
                        ...
                        <div className="flex lg:grid lg:grid-cols-3 gap-5 overflow-x-auto lg:overflow-visible pb-10 snap-x snap-mandatory scroll-smooth [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                            {locations.map((loc) => (
                                ...
                                >
                                    ...
                                    <div
                                        className="absolute inset-0 w-full h-full bg-cover bg-center opacity-0 group-hover:opacity-50 transition-all duration-700 ease-in-out scale-110 group-hover:scale-100"
