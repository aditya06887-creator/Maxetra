...
import man from '../../assets/SVG FOR Ad/General/Web_Development_Home.png'
import home2 from '../../assets/SVG FOR Ad/General/Web_Development_Home_2.png'
  ...
  ">
      ...
      <div className="flex py-4 px-10 text-sm bg-[#001e37]  max-w-7xl mx-auto w-full">
        <ol className="flex items-center space-x-2 md:space-x-4 text-white">
          ...
          <li className="flex items-center">
            <Link to="/digital-marketing-services/webd" className="flex items-center gap-1 hover:text-orange-500 transition-colors">
            Web Development
            </Link>
          </li>
